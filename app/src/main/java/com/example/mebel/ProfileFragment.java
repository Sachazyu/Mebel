    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent moveProfileStg = new Intent(getActivity(), EditProfileActivity.class);
                startActivity(moveProfileStg);
            }
        });

        btn_rating = view.findViewById(R.id.rl_rating);
        btn_rating.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent moveProfileStg = new Intent(getActivity(), PenilaianActivity.class);
                startActivity(moveProfileStg);
            }
        });
